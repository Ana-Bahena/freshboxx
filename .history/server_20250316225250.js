...
doc.text("Subtotal", subtotalX + 5, tableTop + 5, { width: totalWidth - 10, align: "center" });
    ...
    detallesVenta.forEach((producto, index) => {
      ...
      doc.fontSize(12)
        .text(pr_nombre, 50, doc.y, { width: itemWidth, align: "left" })
        .text(cantidad, 150, doc.y, { width: qtyWidth, align: "center" })
        .text(`$${precioNum.toFixed(2)}`, 250, doc.y, { width: priceWidth, align: "center" })
        .text(`$${subtotalNum.toFixed(2)}`, 350, doc.y, { width: totalWidth, align: "center" });
