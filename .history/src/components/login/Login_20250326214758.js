...
import { auth, googleProvider, signInWithPopup, db, doc, getDoc, collection } from "../fire/FirebaseConfig";
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (userSnap.exists()) {
        ...
        localStorage.setItem("userType", userSnap.data().us_tipo);
        setIsLoggedIn(true);
        setUserType(userSnap.data().us_tipo);
      } else {
      ...
      <div className="login-box">
        ...
        {isRegistering ? (
          ...
          <form onSubmit={handleLogin}>
            ...
            <button onClick={handleGoogleLogin} className="google-login-button">Iniciar sesión con Google
            </button>
