  ...
  function Carrito({ carrito, setCarrito }) {
    ...
    const finalizarCompra = async () => {
      ...
      const vt_idFactura = "FACT-" + Date.now(); // Generar un ID de factura basado en el timestamp, puedes usar otro método si es necesario.
      ...
      try {
        const response = await axios.post("http://localhost:5001/api/finalizarcompra", {
          ...
          vt_idFactura: vt_idFactura  // Enviar el ID de factura generado
        });
