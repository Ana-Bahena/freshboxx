...
// Endpoint para obtener los detalles del perfil del cliente
app.get("/perfil", (req, res) => {
  const { us_id } = req.query;  // Usamos el query parameter us_id que se pasa en la solicitud.

  if (!us_id) {
    return res.status(400).json({ success: false, message: "ID de usuario requerido" });
  }

  // Realizamos la consulta para obtener los detalles del cliente
  db.query(
    ...
    (err, results) => {
      ...
      // Enviar la respuesta con los detalles del cliente
