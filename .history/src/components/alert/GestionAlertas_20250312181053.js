    ...
    <div className="container">
      ...
      <style>
        {`
          ...
          .header {
  margin: 0;
  padding: 20px 0; /* Añadí un poco de padding para que el texto no esté tan pegado */
  background-color:rgb(101, 147, 216); /* Color de fondo para asegurar que se vea */
  color: white; /* Asegúrate de que el texto sea visible */
  text-align: center;
  position: relative;
  z-index: 10; /* Para asegurarse de que esté por encima de otros elementos */
}
