...
export default function GestionProductos() {
    ...
    <div className="modal">
        <div className="modal-content">
            ...
            <style>{`
                ...
                .container {
                    margin-top: 100px; /* Da espacio al contenido debajo del header fijo */
                    padding: 20px;
                }
    ...
    justify-content: center;
    align-items: center;
    overflow-y: auto; /* Permite el desplazamiento si la modal es más grande que la pantalla */
    padding: 20px;
}
...
.modal-content {
    ...
    width: 50%;
    max-width: 600px;
    max-height: 80vh; /* Limita la altura para que no se pase de la pantalla */
