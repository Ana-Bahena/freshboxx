...
app.post("/agregar-contenedor", (req, res) => {
  const { peso, status } = req.body;  // Obtenemos los datos enviados desde el frontend

  // Consulta para insertar solo peso y status
  const query = "INSERT INTO freshboxtransportistas (ts_peso, ts_status) VALUES (?, ?)";
