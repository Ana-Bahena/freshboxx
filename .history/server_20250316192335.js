...
app.post("/actualizar-stock", (req, res) => {
  ...
  app.get("/descargar-factura", async (req, res) => {   const { us_id } = req.query;
    console.log("Solicitud de factura para us_id:", us_id);  // 👈 Log de verificación
  
    if (!us_id) {
      console.log("Falta us_id en la solicitud");
