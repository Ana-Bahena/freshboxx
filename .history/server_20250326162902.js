...
*/
const db = mysql.createConnection({
  host: process.env.DB_HOST || "http://dtai.uteq.edu.mx/~bahana228",
  user: process.env.DB_USER || "bahana228",
  password: process.env.DB_PASSWORD || "bsa@2022371113",
  database: process.env.DB_DATABASE || "bd_awos_bahana228",
  port: process.env.DB_PORT || 3306,
  connectTimeout: 100000 // Aumentar tiempo de espera a 100 segundos
});
