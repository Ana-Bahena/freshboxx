  ...
  app.post("/register-transportista", (req, res) => {
    ...
    db.query(
      ...
      (err, result) => {
        ...
        const us_id = result.insertId; // Obtener el ID del usuario recién insertado
  
        // Insertar en la tabla transportistas
        db.query(
          "INSERT INTO freshboxtransportistas (ts_nombre, ts_email, ts_telefono, ts_direccion, ts_rfc, tr_placas, us_id) VALUES (?, ?, ?, ?, ?, ?, ?)",
