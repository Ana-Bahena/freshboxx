...
app.get("/descargar-factura", async (req, res) => {
  ...
  try {
    ...
    // Dibujar cabecera con bordes
    doc.fontSize(12).fillColor('#000000');

    // Dibujar bordes de cabecera
    ...
    doc.text("Subtotal", subtotalX + 5, yPosition + 5, { width: totalWidth - 10, align: "center" });

    yPosition += rowHeight;

    // Dibujar filas de productos con bordes
    let total = 0;
