...
function PagoCompleto() {
  ...
  useEffect(() => {
    ...
    script.src = "script.src = "https://www.paypal.com/sdk/js?client-id=AeeXXQ2QxzE0qAgb96RX4Ri7CGztz4gv8qx8RrApoKp87iOzl6WIiXqhbuS_ywEa5A64dxLlYNo0l6rr";"; // Reemplaza TU_CLIENT_ID
    script.async = true;
    script.onload = () => {
