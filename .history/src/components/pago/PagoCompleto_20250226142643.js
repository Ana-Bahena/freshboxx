...
function PagoCompleto() {
  ...
  useEffect(() => {
    ...
    script.src = "https://sandbox.paypal.com/sdk/js?client-id=AeeXXQ2QxzE0qAgb96RX4Ri7CGztz4gv8qx8RrApoKp87iOzl6WIiXqhbuS_ywEa5A64dxLlYNo0l6rr=MXN"; // Reemplaza TU_CLIENT_ID
    script.async = true;
    script.onload = () => {
