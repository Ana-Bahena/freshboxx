...
// Función para obtener los datos del cliente a partir del us_id
...
app.get("/descargar-factura", async (req, res) => {
  ...
  try {
    ...
    const cliente = await obtenerCliente(us_id); // Esta es la función que ahora existe
    ...
    doc.text(`Nombre: ${cliente.cl_nombre}`);
