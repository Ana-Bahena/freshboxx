...
export default function ControlCargas() {
  ...
  const obtenerContenedores = async () => {
    try {
      ...
      const text = await response.text();  // Lee como texto para inspeccionar la respuesta
      console.log(text);  // Esto te permitirá ver si la respuesta es HTML en lugar de JSON
