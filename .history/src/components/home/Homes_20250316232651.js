...
function Homes({ carrito, setCarrito }) {
  ...
  .filter((producto) => {
    console.log(producto.pr_status); // Verifica los valores
    return producto.pr_status === "Disponible";
  })
  .filter((producto) => producto.pr_nombre.toLowerCase().includes(searchTerm.toLowerCase()));
