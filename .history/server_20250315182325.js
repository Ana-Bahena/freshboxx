...
app.post("/actualizar-stock", (req, res) => {
  ...
  app.post("/registrar-venta", (req, res) => {
    const { cl_id, vt_total, vt_pesoTotal, vt_formaPago, vt_fecha, vt_status, carrito } = req.body;
    ...
    const queryVenta = `
      ...
      VALUES (?, 'pendiente', ?, 'paypal', ?, NOW())`;
  
    db.query(queryVenta, [vt_total, vt_pesoTotal, vt_formaPago, cl_id, vt_fecha, vt_status], (err, result) => {
      if (err) {
