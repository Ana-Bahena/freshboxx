...
export default function GestionProductos() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:5001/inser-productos", nuevoProducto)
        .then((response) => {
            if (response.data.success) {
    ...
    // Redirigir al hacer clic en el ícono de Home
    const handleHomeClick = () => {
        history.push("/admin-dashboard"); // Redirige a admin-dashboard
    };
        ...
        <div className="container">
            ...
            <header className="header">
                ...
                <a href="#" className="home-link" onClick={handleHomeClick}>
                    <FaHome size={40} color="white" />  {/* Ícono de Home */}
                </a>
            </header>
