...
export default function GestionAlertas() {
  ...
  useEffect(() => {
    axios
      .get("https://fresh-back.onrender.com/alertas")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("https://fresh-back.onrender.com/alertas", nuevaAlerta)
      .then((response) => {
        if (response.data.success) {
  ...
  const handleUpdate = () => {
    axios
      .put(`https://fresh-back.onrender.comhttp://localhost:5001/alertas/${alertaEdit.id}`, alertaEdit)
      .then((response) => {
        if (response.data.success) {
          setAlertas(
