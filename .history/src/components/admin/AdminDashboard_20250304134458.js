      ...
      <style jsx>{`
        * {
        ...
        .footer {
          ...
          h3 {
  font-size: 1px; /* Tamaño de fuente más pequeño */
  font-weight: normal; /* Opcional: Reduce el grosor de la letra */
  color: #ffffff; /* Color blanco para contrastar si el fondo es oscuro */
