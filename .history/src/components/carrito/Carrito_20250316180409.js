  ...
  function Carrito({ carrito, setCarrito }) {
    ...
    const finalizarCompra = async () => {
      ...
      try {
        const response = await axios.post("http://localhost:5001/api/finalizarcompra", { params: { us_id: userId } }); {
          carrito: carrito,
          us_id: parseInt(userId), // Asegúrate de enviar el ID como número
