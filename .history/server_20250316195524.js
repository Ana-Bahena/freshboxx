...
app.post("/actualizar-stock", (req, res) => {
  ...
  const PDFDocument = require("pdfkit"); // Asegúrate de requerir PDFKit
  ...
  app.get("/descargar-factura", async (req, res) => {
    ...
    try {
      // Simular cliente (ajusta según tu base de datos real)
      const cliente = await obtenerCliente(us_id); // Implementa esta función según tu DB
