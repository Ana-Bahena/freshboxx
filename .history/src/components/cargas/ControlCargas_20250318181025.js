...
export default function ControlCargas() {
  ...
  const handleSubmitContenedor = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("/agregar-contenedor", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify(contenedor), // Enviar solo peso y status
      });
  ...
  return (
    <div className="container">
      ...
      <div className="forms-wrapper">
        <div className="form-container carga-form-container left">
        ...
        <div className="form-container carga-form-container right">
