...
app.post("/register-transportista", async (req, res) => {
  ...
  try {
    ...
    // Insertar en la tabla `usuarios` solo con tipo 'transportista'
    db.query(
      ...
      (err, result) => {
        ...
        db.query(
          ...
          (err) => {
            ...
            console.log("Transportista registrado correctamente");
            res.json({ success: true, message: "Registro de transportista exitoso" });
          }
        );
      }
    );
