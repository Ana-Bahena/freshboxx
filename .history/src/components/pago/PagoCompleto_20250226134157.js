...
function PagoCompleto() {
  ...
  useEffect(() => {
    ...
    script.src = "https://www.paypal.com/sdk/js?client-id=AT6_RUiYzNXoHOUlGdT26EVx8Gzse52hTQAvLsZ4dzwlBAJ10pEijGjLOpLgICEDFZ1jfZ9zMH8YPYEz=MXN"; // Reemplaza TU_CLIENT_ID
    script.async = true;
    script.onload = () => {
