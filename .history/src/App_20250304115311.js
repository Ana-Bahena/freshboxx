...
function App() {
  ...
  useEffect(() => {
    const userSession = localStorage.getItem("userSession"); // Cambiado de "us_id" a "userSession"
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin-dashboard" element={isLoggedIn && isAdmin ? <AdminDashboard /> : <Navigate to="/" />} />
