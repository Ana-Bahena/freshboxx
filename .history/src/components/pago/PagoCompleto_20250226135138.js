...
function PagoCompleto() {
  ...
  useEffect(() => {
    ...
    script.src = "https://sandbox.paypal.com/sdk/js?client-id=EDZogqDVt6SYhOdPxcTJW96uq-WStRXQy6yCHQZsHH8bNQcyjm0DHBkmGMJ3Faed4nhAkv2WzAqdCohP=MXN"; // Reemplaza TU_CLIENT_ID
    script.async = true;
    script.onload = () => {
