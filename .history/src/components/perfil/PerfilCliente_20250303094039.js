...
const PerfilCliente = () => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("userType"); // Si usas otro dato de sesión, también se elimina
    ...
    <div>
      ...
      <header style={styles.header}>
        ...
        <div className="header-icons">
          ...
          <FaSignOutAlt size={24} style={styles.icon} onClick={handleLogout} title="Cerrar sesión" />
